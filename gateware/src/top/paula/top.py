...
class Paula2Top(Elaboratable):
    ...
    # PAULA_MIN_PERIOD=60 & STRHOR_RATE=92 => 417Hz ( G#4 )
    # PAULA_MIN_PERIOD=50 & STRHOR_RATE=76 => 500Hz ( B4 )
    # PAULA_MIN_PERIOD=40 & STRHOR_RATE=61 => 626Hz ( D#5 )
    # PAULA_MIN_PERIOD=20 & STRHOR_RATE=30 => 1252Hz ( D#6 )
    PAULA_MIN_PERIOD = 20
