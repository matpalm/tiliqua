...
# version from v1 port. didn't end up using this in v2 ( already sounds ok with
# vanilla truncation ) . kept for later if needed


class Dither8BitQuantiser(Elaboratable):
    """TPDF dither + signed 8-bit quantisation"""
